...
$LNG['explore_desc'] = 'Yeni müzikler keşfedin, yeni insanlar keşfetmedin ve sanatçılarıda';
$LNG['share_desc'] = 'En sevdiğiniz müzikleri sosyal ağlarda arkadaşlarınızla paylaşın';
$LNG['organize_desc'] = 'Çalma listeleri oluşturun ve müzik istediğiniz şekilde düzenleyin';
...
$LNG['image_removed'] = 'Resim Silindi';
$LNG['profile_picture_removed'] = 'Profil fotoğrafı silindi.';
$LNG['profile_description'] = 'Profil açıklaması: %s karakter veya daha az olmalıdır.';
$LNG['playlist_description'] = 'Çalma listesi açıklaması %s karakter veya daha az olmalıdır .';
$LNG['playlist_name_empty'] = 'Çalma listesi adı boş olamaz.';
$LNG['changes_saved'] = 'Değişiklikler başarıyla kaydedildi.';
$LNG['valid_email'] = 'Geçerli bir e-posta girin lütfen.';
$LNG['valid_url'] = 'Geçerli bir URL biçimi girin lütfen.';
$LNG['valid_country'] = 'Geçerli bir ülke girin lütfen ';
$LNG['background_changed'] = ' Arka plan başarılı bir şekilde değiştirildi.';
$LNG['background_not_changed'] = 'Arka plan değiştirilemedi.';
$LNG['password_too_short'] = 'Parola en az<strong>3</strong> karakter içermelidir .';
$LNG['username_not_found'] = 'Bu Kullanıcı Adını bulamadık';
$LNG['userkey_not_found'] = 'Kullanıcı adı veya şifre yanlış girilmiş. Doğru girdiğinden emin ol.';
$LNG['email_reset'] = 'Yeni şifreni içeren mail e-posta adresine gönderildi. 24 saat içinde elinde olur. Gereksizler kutusuna bakmayı unutma!.';
$LNG['user_deleted'] = 'Kullanıcı Silinmiş';
$LNG['user_has_been_deleted'] = 'Kullanıcı Adı <strong>%s</strong> silindi.';
$LNG['user_not_deleted'] = 'Kullanıcı Adı (ID: %s) silinemedi.';
$LNG['user_not_exist'] = 'Seçili kullanıcı yok.';
...
$LNG['notif_success_saved'] = 'Bildirimlerin başarılı bir şekilde güncellendi.';

// MAIL CONTENT //
$LNG['welcome_mail'] = 'Welcome to %s';
$LNG['email_footer_unsub'] = '<br /><br /><span style="color: #aaa;">Bu mail otomatik olarak gönderildi. Eğer bir daha bu adresten <strong>%s</strong> bildirim almak istemiyorsanız, lütfen <a href="%s">Unsubscribe</a>.</span>';
...
$LNG['user_created'] = 'Bize katıldığınız için teşekkürler <strong>%s</strong><br /><br />Kullanıcı adınız: <strong>%s</strong><br />Şifreniz: <strong>%s</strong><br /><br />Buradan giriş yapabilirsiniz: <a href="%s" target="_blank">%s</a>'.$LNG['email_footer_gen'];
$LNG['recover_mail'] = 'Şifreni yenile';
$LNG['recover_content'] = 'Şifre yenilenmesi söz konusu. Eğer onaylamıyorsanız bu maili silin. <br /><br />Kullanıcı adınız: <strong>%s</strong><br />Yeni Şifreniz: <strong>%s</strong><br /><br />Şifrenizi bu linke tıklayarak tekrar değiştirebilirsiniz: <a href="%s" target="_blank">%s</a>'.$LNG['email_footer_gen'];
$LNG['ttl_comment_email'] = '%s şarkına yorum yaptı';
$LNG['comment_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong>, bu şarkına yorum yaptı: <strong><a href="%s"> .</a></strong>'.$LNG['email_footer_unsub'];
$LNG['ttl_like_email'] = '%s şarkını beğendi';
$LNG['like_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> bu şarkını beğendi: <strong><a href="%s">.</a></strong>'.$LNG['email_footer_unsub'];
$LNG['ttl_new_friend_email'] = '%s seni arkadaş olarak ekledi';
$LNG['new_friend_email'] = $LNG['email_hello'].'<strong><a href="%s">%s</a></strong> seni arkadaş olarak ekledi.'.$LNG['email_footer_unsub'];
$LNG['ttl_copyright_notification'] = 'Telif hakkı iddia et - %s';
$LNG['copyright_mail_0'] = $LNG['email_hello'].'Bu şarkın: <a href="%s">%s</a> telif hakkı iddiası nedeniyle iptal edildi. İddia eden kişi: <a href="%s">%s</a>. Eğer hata olduğunu düşünüyorsan bizimle iletişime geç. Case ID: %s'.$LNG['email_footer_gen'];
$LNG['copyright_mail_1'] = $LNG['email_hello'].'Bu şarkı ihlal kuralları neticesinde iptal edildi: <a href="%s">%s</a> . Teşekkürler. Case ID: %s'.$LNG['email_footer_gen'];
$LNG['ttl_suspended_account_mail'] = 'Hesabınız iptal edildi';
$LNG['suspended_account_mail'] = $LNG['email_hello'].'Hesabınız iptal edildi. Eğer bunun bir hata olduğunu düşünüyorsanız bizimle iletişime geçin.'.$LNG['email_footer_gen'];

// ADMIN PANEL //
$LNG['general_link'] = 'Genel';
$LNG['security_link'] = 'Güvenlik';
$LNG['manage_users'] = 'Kullanıcı ayarları';

$LNG['theme_install'] = 'Yeni bir tema için bu dosya yükleyin <strong>themes</strong> .';
$LNG['theme_author_homepage'] = 'Yapımcının Web Sitesine Git';
$LNG['theme_version'] = 'Versiyon';
$LNG['theme_active'] = 'Aktif';
$LNG['theme_activate'] = 'Aktif Değil';
$LNG['theme_by'] = 'Yapımcı';

// STREAM //
$LNG['welcome_stream_ttl'] = 'Akışa Hosgeldin';
$LNG['welcome_stream'] = 'Arkadaşlarınızdan tüm parçalar, bu sayfada görünür yeni arkadaşlar yaparak başlayacak.';
$LNG['welcome_timeline_ttl'] = 'Haber akışına hoşgeldin';
$LNG['welcome_timeline'] = 'Tüm şarkılar bu sayfada görüntülenir, şarkılara düşüncelerinizi ve yorumları yazabilirsiniz ';
$LNG['leave_comment'] = 'Bir şeyler yaz...';
$LNG['post'] = 'Gönder';
$LNG['view_more_comments'] = 'Daha fazla yorum göster';
$LNG['this_track_private'] = 'Şarkı Gizlenmiş';
$LNG['this_track_public'] = 'Şarkı Herkese Açık';
$LNG['this_playlist_private'] = 'Çalma Listesi Gizlenmiş';
$LNG['this_playlist_public'] = 'Çalma Listesi Herkese Açık';
$LNG['delete_this_comment'] = 'Yorumu Sil';
$LNG['delete_this_message'] = 'Mesajı Sil';
$LNG['delete_this_track'] = 'Şarkıyı Sil';
$LNG['delete_this_playlist'] = 'Çalma Listeni Sil';
$LNG['report_this_track'] = 'Şarkıyı Bildir';
$LNG['report_this_comment'] = 'Yorumu Bildir!';
$LNG['load_more'] = 'Daha fazlasını yükle';
$LNG['view_more'] = 'Daha fazlasını görüntüle';
$LNG['comment_wrong'] = 'Bir şeyler ters gitti. Sayfayı yenile düzelir inşallah.';
$LNG['comment_too_long'] = 'Üzgünüm ama bir yorum için maksimum karakter sayısı <strong>%s</strong>.';
$LNG['comment_error'] = 'Üzgünüm ama yorumunu yollayamadım. Sayfayı yenileyip tekrar dene :).';
$LNG['track_hidden_1'] = 'Üzgünüm ama bu şarkı özel. Sadece sahibi bu şarkıyı görebilir.';
$LNG['track_hidden_2'] = 'Üzgünüm ama bu şarkıyı sadece bu yazarın takipçileri görebilir.';
$LNG['track_hidden_1_ttl'] = $LNG['track_hidden_2_ttl'] = 'Özel Şarkı';
$LNG['track_suspended_1'] = 'Üzgünüm ama bu şarkı telif hakkı suçlamaları nedeniyle iptal edildi. Eğer bunun bir hata olduğunu düşünüyorsan bizimle iletişime geç.';
$LNG['track_suspended_1_ttl'] = 'Engellenmiş şarkı';
$LNG['playlist_hidden'] = 'Üzgünüm ama bu şarkı listesini sadece yazarı görebilir.';
$LNG['playlist_hidden_ttl'] = 'Özel Şarkı Listesi';
$LNG['comment'] = 'Yorum';
$LNG['share'] = 'Paylaş';
$LNG['autoplay'] = 'Otamatik Oynat';
$LNG['add_to'] = 'Ekle';
$LNG['buy'] = 'Satın Al';
$LNG['download'] = 'İndir';
...
// REPORT //
$LNG['1_not_exists'] = 'Bahsettiğiniz şarkı bulunamadı.';
$LNG['0_not_exists'] = 'Bahsettiğiniz yorum bulunamadı.';
$LNG['1_already_reported'] = 'Bu şarkı daha önceden bize bildirildi. Bi gözden geçirelim. Teşekkürler :).';
$LNG['0_already_reported'] = 'Bu yorum daha önceden bize bildirildi. Bi gözden geçirelim. Teşekkürler :).';
$LNG['1_is_safe'] = 'Bu parça admin taradından bu şekilde işaretlendi: <strong>safe</strong>, geri bildirimin için sana müteşekkiriz :)';
$LNG['0_is_safe'] = 'Bu yorum admin tarafından bu şekilde işaretlendi: <strong>safe</strong>, geri bildirimin için sana müteşekkiriz :)';
$LNG['1_report_added'] = 'Bu şarkı şikayet edildi. Bize bildirdiğin için teşekkürler.';
$LNG['0_report_added'] = 'Bu yorum şikayet edildi. Bize bildirdiğin için teşekkürler.';
$LNG['1_report_error'] = 'Şarkıyı şikayet ederken bir şeyler ters gitti. Sayfayı yenileyip tekrar dene.';
$LNG['0_report_error'] = 'Yorumu şikayet ederken bir şeyler ters gitti. Sayfayı yenileyip tekrar dene.';
$LNG['1_is_deleted'] = 'Bu şarkı zaten silinmiş.';
$LNG['0_is_deleted'] = 'Bu yorum zaten silinmiş.';
$LNG['deleted_track'] = 'Şarkı silindi.';
$LNG['deleted_comment'] = 'Yorum silindi.';
$LNG['suspended_track'] = 'Şarkı iptal edildi.';
$LNG['safe_report'] = 'Şikayet güvenli olarak işaretlendi.';
$LNG['rci'] = 'Telif hakkı ihlali olarak şikayet et';
$LNG['report_track'] = 'Şarkıyı şikayet et';
$LNG['signature'] = 'İmza';
$LNG['sub_signature'] = 'Bu kutucukta senin tam isminin yazılması senin imzan olarak kabul ediliyor.';
...
$LNG['rep_resc_error'] = 'Tanım %s karakterden az olmalıdır.';
$LNG['abusive_comment'] = 'Uygunsuz yorum';
$LNG['copyright_infringement'] = 'Telif hakkı ihlali';
$LNG['claimant'] = 'Claimant';
$LNG['infringing_material'] = 'Infringing Material';
$LNG['reported_by'] = 'Tarafından şikayet edildi';
$LNG['delete_track'] = 'Şarkıyı sil';
$LNG['delete_comment'] = 'Yorumu sil';
$LNG['delete_report'] = 'Şikayeti sil';
$LNG['suspend_track'] = 'Şarkıyı iptal et';

// SIDEBAR //
$LNG['filter_notifications'] = 'Filter Notifications';
$LNG['archive'] = 'Arşivler';
$LNG['statistics'] = 'İstatistik';
$LNG['all_notifications'] = 'Bütün Bildirimler';
$LNG['all_time'] = 'Bütün zamanlar';
$LNG['subscriptions'] = 'Takip';
$LNG['subscribers'] = 'Takipçiler';
$LNG['welcome'] = 'Hoşgeldin';
$LNG['sidebar_people'] = 'Kişiler';
$LNG['sidebar_tracks'] = 'Şarkılar';
$LNG['sidebar_playlists'] = 'Şarkı Listeleri';
...
$LNG['sidebar_chats'] = 'Konuşmalar';
$LNG['sidebar_suggestions'] = 'Arkadaş Önerileri';
$LNG['sidebar_trending'] = 'Gündemdekiler';
$LNG['sidebar_friends_activity'] = 'Arkadaşlarımın Aktiviteleri';
$LNG['edit_track'] = 'Şarkıyı Düzenle';
$LNG['edit_playlist'] = 'Şarkı Listesini Düzenle';
...
$LNG['blocked_user'] = 'Mesaj gönderilemedi. You\'ve blocked <strong>%s</strong>.';
$LNG['chat_self'] = 'Üzgünüm ama kendine mesaj atman gereksiz.';
$LNG['chat_no_user'] = 'Mesajlaşmak için birini seçmelisin.';
$LNG['view_more_conversations'] = 'Daha fazla sohbet gör';
$LNG['block'] = 'Engelle';
$LNG['unblock'] = 'Engeli Kaldır';
$LNG['conversation'] = 'Sohbetler';
$LNG['start_conversation'] = 'Arkadaş listenden birini seçerek sohbet oluşturabilirsin.';
...
$LNG ['0_upload_err'] = 'Bu dosya boyutu bayağı büyük, biraz daha küçük boyutlu bir dosya seçersen hani :) ';
$LNG ['1_upload_err'] = 'hiçbir dosya seçilmemiş';
$LNG ['2_upload_err'] = ' Seçili dosya çok büyük. En fazla izin. %s dosya boyutudur';
$LNG['3_upload_err'] = 'Seçilen dosya uygun formatta değil. Upload a %s audio file type';
...
$LNG['6_upload_err'] = 'Tanım %s karakterden az olmalıdır.';
$LNG['7_upload_err'] = '"Satın al" linki geçerli bir URL içermiyor.';
$LNG['8_upload_err'] = 'You can only add up to %s tags';
$LNG['9_upload_err'] = 'You need to add at least %s tag';
$LNG['10_upload_err'] = 'Şarkı başlığı boş olamaz';
$LNG['11_upload_err'] = 'Şarkı başlığı %s karakterden fazla olamaz.';
$LNG['track_updated'] = 'Şarkı başarıyla yüklendi!';
$LNG['view_track'] = 'Şarkıyı görüntüle';
$LNG['congratulations'] = 'Helaaal';
$LNG['track_uploaded'] = 'Şarkı başarıyla yüklendi!';
$LNG['or'] = 'veya';

$LNG['license'] = 'Lisans';
$LNG['licensed_under'] = 'Licensed under';
$LNG['metadata'] = 'Metadata';
$LNG['permissions'] = 'İzin';
$LNG['buy_link'] = 'Satın Al';
$LNG['release_date'] = 'Yayınlanma tarihi';
$LNG['tags'] = 'Etiketler';
$LNG['edit_tags'] = 'separated by comma, including genres';
$LNG['visibility'] = 'Görünürlük';
$LNG['allow_downloads'] = 'İndirmelere izin ver';
...
$LNG['user_ttl_social'] = 'Sosyal ağ profillerin';
$LNG['user_ttl_plan'] = 'Hesap Planı';

$LNG['user_desc_general'] = 'Hesap, gizlilik ve konum ayarlarını değiştir.';
$LNG['user_desc_security'] = 'Şifreni değiştir.';
$LNG['user_desc_avatar'] = 'Profil Fotoğrafını Değiştir.';
$LNG['user_desc_cover'] = 'Kapak Fotoğrafını Değiştir.';
$LNG['user_desc_notifications'] = 'Bildirim Ayarlarını Değiştir.';

$LNG['ttl_background'] = 'Arkaplan';
$LNG['sub_background'] = 'Profilin için bir arkaplan oluştur';

$LNG['ttl_first_name'] = 'İsim';
$LNG['sub_first_name'] = 'Soyismini yaz';

$LNG['ttl_last_name'] = 'Soyisim';
$LNG['sub_last_name'] = 'Soyismini yaz';

$LNG['ttl_email'] = 'E-posta';
$LNG['sub_email'] = 'E-Postan gösterilmeyecek';

$LNG['ttl_country'] = 'Ülken';
$LNG['sub_country'] = 'Yaşadığın ülke';

$LNG['ttl_city'] = 'Şehir';
$LNG['sub_city'] = 'Yaşadığın şehir';

$LNG['ttl_website'] = 'İnternet Adresin';
$LNG['sub_website'] = 'Blogun falan varsa işte';

$LNG['ttl_profile'] = 'Profil';
$LNG['sub_profile'] = 'Profil Gizliliği';

$LNG['ttl_offline'] = 'Sohbet Durumu';
$LNG['sub_offline'] = 'Sohbet Görünebilirliği';

$LNG['ttl_facebook'] = 'Facebook';
$LNG['sub_facebook'] = 'Facebook linkin.';

$LNG['ttl_twitter'] = 'Twitter';
$LNG['sub_twitter'] = 'Twitter linkin.';

$LNG['ttl_google'] = 'Google+';
$LNG['sub_google'] = 'Google+ linkin.';

$LNG['ttl_youtube'] = 'YouTube';
$LNG['sub_youtube'] = 'YouTube linkin.';

$LNG['ttl_soundcloud'] = 'SoundCloud';
$LNG['sub_soundcloud'] = 'SoundCloud linkin.';

$LNG['ttl_myspace'] = 'MySpace';
$LNG['sub_myspace'] = 'MySpace linkin.';

$LNG['ttl_tumblr'] = 'Tumblr';
$LNG['sub_tumblr'] = 'Tumblr linkin.';

$LNG['ttl_vimeo'] = 'Vimeo';
$LNG['sub_vimeo'] = 'Vimeo linkin.';

$LNG['ttl_lastfm'] = 'Last.fm';
$LNG['sub_lastfm'] = 'Last.fm linkin.';

$LNG['ttl_description'] = 'Tanım';
$LNG['sub_description'] = 'Profil tanımı (160 karakter veya daha azı)';

$LNG['ttl_born'] = 'Doğum Tarihin';
$LNG['sub_born'] = 'Doğduğun tarihi seç';

$LNG['ttl_upload_avatar'] = 'Seçili profil fotoğrafını yükle';
$LNG['ttl_delete_avatar'] = 'Şu anki profil fotoğrafını sil';
...
$LNG['sub_password'] = 'Yeni bir şifre gir (en az 3 karakter)';
...
$LNG['desc_admin_user'] = 'Admin Kullanıcı Adını Yaz';
$LNG['admin_pass'] = 'Şifre';
$LNG['desc_admin_pass'] = 'Admin şifreni yaz';
$LNG['admin_menu_general'] = 'Genel Ayarlar';
$LNG['admin_menu_security'] = 'Şifre';
...
$LNG ['suspend'] = 'Askıda';
$LNG ['geri'] = 'Geri';
$LNG ['recover_sub_username'] = 'Kullanıcı adı şifre kurtarmak istediğiniz türü';
$LNG ['delete_track_desc'] = ' Bu parca silmek istediğinizden emin misiniz?';
$LNG ['delete_playlist_desc'] = 'Bu listesi silmek istedi─ƒinize emin misiniz?';
$LNG ['delete_account'] = 'bir hesabı silmeden sunucudan tüm bilgileri siler ve eylem döndürülmesi imkansızdır';
$LNG ['suspend_account'] = ' hesabına erişimi bir hesap askıya alma ve onun içeriği gizlenir';
$LNG ['restore_account'] = ' Hesap geri erişim hesabının ve içerik için açık';
$LNG ['account_suspended'] = 'Bu hesap şu anda askıya alınmış durumda.';
$LNG ['view'] = 'Bak';
...
$LNG ['payment_error_0'] = 'isteği başarısız oldu';
$LNG ['payment_error_1'] = 'senin ödeme iptal edildi.';
$LNG['pro_plan'] = 'Pro Plan';
$LNG ['pro_plan_desc'] = 'Pro hesap türü';
$LNG ['valid'] = 'Geçerli';
$LNG ['valid_desc'] = 'Senin hesap durumu valability.';
$LNG ['expire_on'] = 'Bitiş';
$LNG ['monthly'] = 'Aylık';
$LNG ['yearly'] = 'Yıllık';
$LNG ['days_left'] = 'gün kaldı';
$LNG ['account_status'] = 'Senin geçerli hesap durumu';
$LNG ['transactions_history'] = 'İşlem geçmişi';
$LNG ['history'] = 'Tarih';
$LNG ['payments'] = 'Ödemeleri';
$LNG ['completed'] = 'Tamamlandı';
$LNG ['refunded'] = 'Refunded';
$LNG ['reversed'] = 'Ters işlem';
$LNG ['pending'] = 'Askıda';
$LNG ['suspended'] = 'Askıya Aldık :(';
...
$LNG['amount'] = 'Ücret';
$LNG['date'] = 'Ay';
$LNG['plan'] = 'Pro Hesap Türü';
$LNG['transaction_id'] = 'İşlem Numarası';
$LNG['transaction_details'] = 'İşlem Ayrıntıları';
...
$LNG['title_admin']	= 'Ufacık Tefecik Panel';
$LNG['on'] = 'Aç';
$LNG['off'] = 'Kapat';
$LNG['no'] = 'Hayır';
$LNG['yes'] = 'Evet';
...
$LNG['send'] = 'Gönder';
$LNG['all'] = 'Hepsi';
$LNG['categories'] = 'Katagoriler';
$LNG['stream'] = 'Akıs';
$LNG['track'] = 'Parça';
$LNG['tracks'] = 'Parçalar';
$LNG['pages'] = 'Sayfalar';
$LNG['report'] = 'Bildir';
$LNG['stats'] = 'İstatistikleri';
$LNG['author'] = 'Sanatçı';
$LNG['popular_music'] = 'Popüler Müzik';
$LNG['go_pro'] = 'Pro Uyelik Al';
$LNG['edit'] = 'Duzenle';
$LNG['upload'] = 'Yukle';
...
$LNG['about'] = 'Hakkında';
$LNG['disclaimer'] = 'Yasal uyarı';
$LNG['contact'] = 'İletisim';
$LNG['api_documentation'] = 'API Dosyaları';
